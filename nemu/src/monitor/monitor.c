  ...
  while ( (o = getopt_long(argc, argv, "-bhl:d:p:e:f:", table, NULL)) != -1) {
    switch (o) {
      ...
      default:
        ...
        printf("\t-e,--expr-test=FILE     test expressions from FILE\n");
        printf("\t-f,--ftrace=ELF          trace functions using ELF symbols\n");
        printf("\n");
        exit(0);
    }
  }
...
void init_monitor(int argc, char *argv[]) {
  ...
  /* Load function symbols for ftrace. */
